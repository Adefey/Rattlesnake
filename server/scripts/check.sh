...
check_log "cppcheck --enable=all --inconclusive --error-exitcode=1 ./include/* ./sources_machine/* ./sources_common/* ./sources_server_application/* ./test/* --suppress=missingIncludeSystem" "\(information\)"
